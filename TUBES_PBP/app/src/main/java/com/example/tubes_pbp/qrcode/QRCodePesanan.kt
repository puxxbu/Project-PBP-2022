...
import com.example.tubes_pbp.databinding.ActivityQrcodePesananBinding
import com.example.tubes_pbp.webapi.pesananapi.PesananData
import com.example.tubes_pbp.webapi.pesananapi.FormAddPesananActivity
...
class QRCodePesanan : AppCompatActivity(), View.OnClickListener {

    private lateinit var binding : ActivityQrcodePesananBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQrcodePesananBinding.inflate(layoutInflater)
    ...
    private fun extractbarcodeQrCodeInfo(barcodes: List<Barcode>) {
        for (barcode in barcodes) {
            ...
            if (jsonObj is JSONObject){
                var gson = Gson()
                var testModel = gson.fromJson(rawValue, PesananData::class.java)
                var i = Intent(this@QRCodePesanan, FormAddPesananActivity::class.java).apply {
